...
# in-memory database so the schema created in setup is visible to test threads.
...
def test_admin_login_redirects_when_not_authenticated():
    """Verifica che la dashboard richieda autenticazione"""
    response = client.get("/en/admin/dashboard", follow_redirects=False)
