translations = {
    "it": {
        ...
        "general": {
            ...
            "download-cv": "Scarica il mio CV",
            "back-to-home": "Torna alla Home",
            "back-to-projects": "Torna ai Progetti",
            "footer-text": "© 2024 Stefano Videsott. Tutti i diritti riservati.",
        ...
        "home": {
            ...
            "about-desc-3": "Quando non sto programmando, mi piace suonare, esplorare progetti, sperimentare le ultime novità in AI ed accrescere le mie conoscenze attraverso blog, tutorial e post.",
            "skills-title": "Competenze",
            "skills-prog": "Programmazione",
            "skills-web": "Sviluppo Web",
            "skills-db": "Database",
            "skills-cloud": "DevOps & Cloud",
            "skills-prog-list": "Sviluppo di applicazioni, giochi e script con C++, C#, Rust, Python, Java, Javascript e Bash.",
        ...
        "projects": {
            "title": "Progetti",
            "p1-title": "Air Force 1943",
            "p1-desc": "Ho partecipato allo sviluppo di Air Force 1943 all'età di 15 anni durante il liceo.",
            "p1-link": "Visualizza su itch.io",
            "p2-title": "Unitn P2 Configuration",
            "p2-desc": "Ho creato uno script per automatizzare l'installazione dell'ambiente di laboratorio per il corso P2 all'Università di Trento.",
            "p2-link": "Visualizza su GitHub",
            "p3-title": "WannaWork",
            "p3-desc": "Piattaforma di job matching locale per studenti e imprese (Progetto di Ingegneria del Software).",
            "p3-link": "Scopri di più"
        },
        "wannawork": {
            "title": "WannaWork - Job Matching",
            "subtitle": "Progetto per il corso di Ingegneria del Software all'Università di Trento",
            "what-is": "Cos'è WannaWork?",
            "what-is-text": "WannaWork è un'applicazione web (Single Page Application) progettata per facilitare il job matching a livello locale. Mette in comunicazione gli studenti, che possono creare profili, caricare CV e cercare offerte part-time, con i datori di lavoro locali, che possono pubblicare annunci e gestire le candidature.",
            "problem": "Il Problema e la Soluzione",
            "problem-text": "Nasce per risolvere la difficoltà degli studenti nel trovare lavori part-time flessibili e per digitalizzare la ricerca di lavoro locale, spesso ancora legata al CV cartaceo. Centralizzando questo processo, crea un ponte diretto tra piccole imprese e giovani del territorio, favorendo l'economia e l'inserimento lavorativo.",
            "tech": "Stack Tecnologico",
            "tech-front": "Frontend: Vue.js 3 (Composition API), Pinia, Vue Router, TailwindCSS e DaisyUI.",
            "tech-back": "Backend: Node.js, Express.js (API RESTful), JWT per autenticazione stateless, bcryptjs.",
            "tech-db": "Database: MongoDB (NoSQL) con Mongoose ODM.",
            "tech-devops": "Testing & DevOps: Jest, Supertest, OpenAPI (Swagger), Docker, Nginx, Let's Encrypt. Doppio deployment (Render.com e Self-Hosted su Arch Linux).",
            "docs": "Documentazione Ingegneristica",
            "docs-d1": "D1 - Analisi dei Requisiti: Pitch, requisiti funzionali/non funzionali, Use Case, User Story e mockup.",
            "docs-d2": "D2 - Design e Implementazione: Architettura, API RESTful, schema E-R, testing e deployment.",
            "docs-d3": "D3 - Analisi e Progettazione: Diagrammi UML (Componenti e Classi).",
    ...
    "en": {
        ...
        "general": {
            ...
            "footer-text": "© 2024 Stefano Videsott. All rights reserved.",
        ...
        "home": {
            ...
            "about-desc-3": "When I'm not coding, I enjoy playing music, exploring projects, experimenting with the latest in AI, and expanding my knowledge through blogs, tutorials and posts.",
            "skills-title": "Skills",
            "skills-prog": "Programming",
            "skills-web": "Web Development",
            "skills-db": "Databases",
            "skills-cloud": "DevOps & Cloud",
            "skills-prog-list": "Application, game, and scripts development using C++, C#, Rust, Python, Java, Javascript and Bash.",
        ...
        "projects": {
            "title": "Projects",
            "p1-title": "Air Force 1943",
            "p1-desc": "I participated in the development of Air Force 1943 at the age of 15 while in high school.",
            "p1-link": "View on itch.io",
            "p2-title": "Unitn P2 Configuration",
            "p2-desc": "I created a script for automating the installation of the lab environment for the P2 course at the University of Trento.",
            "p2-link": "View on GitHub",
            "p3-title": "WannaWork",
            "p3-desc": "Local job matching platform for students and businesses (Software Engineering Project).",
            "p3-link": "Read More"
        },
        "wannawork": {
            "title": "WannaWork - Job Matching",
            "subtitle": "Software Engineering Project at the University of Trento",
            "what-is": "What is WannaWork?",
            "what-is-text": "WannaWork is a Single Page Application designed to facilitate local job matching. It connects students, who can create profiles, upload resumes, and search for part-time jobs, with local employers, who can post jobs and manage applications.",
            "problem": "The Problem & Solution",
            "problem-text": "It was created to solve the difficulty students face in finding flexible part-time jobs and to digitize local job hunting, which often still relies on paper resumes. By centralizing this process, it creates a direct bridge between small businesses and local youth, boosting the economy and youth employment.",
            "tech": "Tech Stack",
            "tech-front": "Frontend: Vue.js 3 (Composition API), Pinia, Vue Router, TailwindCSS, and DaisyUI.",
            "tech-back": "Backend: Node.js, Express.js (RESTful APIs), JWT for stateless authentication, bcryptjs.",
            "tech-db": "Database: MongoDB (NoSQL) with Mongoose ODM.",
            "tech-devops": "Testing & DevOps: Jest, Supertest, OpenAPI (Swagger), Docker, Nginx, Let's Encrypt. Dual deployment (Render.com and Self-Hosted on Arch Linux).",
            "docs": "Engineering Documentation",
            "docs-d1": "D1 - Requirements Analysis: Pitch, functional/non-functional requirements, Use Cases, User Stories, and mockups.",
            "docs-d2": "D2 - Design & Implementation: Architecture, RESTful APIs, E-R schema, testing, and deployment.",
            "docs-d3": "D3 - Analysis & Design: Advanced UML Diagrams (Component and Class diagrams).",
